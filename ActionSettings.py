...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        Dialog.setStyleSheet("background-color: rgb(240, 248, 255);")
        ...
        self.hostName.setStyleSheet("background-color: rgb(255, 255, 240);")
        ...
        self.portNumber.setStyleSheet("background-color: rgb(255, 255, 240);")
        ...
        self.senderEmail.setStyleSheet("background-color: rgb(255, 255, 240);")
        ...
        self.password.setStyleSheet("background-color: rgb(255, 255, 240);")
        ...
        self.save.setStyleSheet("background-color: rgb(70, 130, 180); color: white;")
