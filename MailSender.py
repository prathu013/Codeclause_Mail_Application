...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.send.setStyleSheet("background-color: rgb(0, 123, 255); color: rgb(255, 255, 255); font-weight: bold;")
        ...
        self.receiversEmail.setStyleSheet("background-color: rgb(255, 255, 255); border: 1px solid rgb(200, 200, 200);")
        ...
        self.getEmailFile.setStyleSheet("background-color: rgb(108, 117, 125); color: rgb(255, 255, 255); font-weight: bold;")
        ...
        self.subject.setStyleSheet("background-color: rgb(255, 255, 255); border: 1px solid rgb(200, 200, 200);")
        ...
        self.senderName.setStyleSheet("background-color: rgb(255, 255, 255); border: 1px solid rgb(200, 200, 200);")
        ...
        self.attachmentPath.setStyleSheet("background-color: rgb(255, 255, 255); border: 1px solid rgb(200, 200, 200);")
        ...
        self.attachbutton.setStyleSheet("background-color: rgb(32, 178, 170); color: rgb(255, 255, 255); font-weight: bold;")
        ...
        self.deleteAttachButton.setStyleSheet("background-color: rgb(220, 53, 69); color: rgb(255, 255, 255); font-weight: bold;")
        ...
        self.message.setStyleSheet("background-color: rgb(255, 255, 255); border: 1px solid rgb(200, 200, 200);")
        self.message.setObjectName("message")
        self.log = QtWidgets.QTextEdit(self.centralwidget)
        self.log.setGeometry(QtCore.QRect(100, 460, 561, 41))
        self.log.setStyleSheet("background-color: rgb(255, 255, 255); border: 1px solid rgb(200, 200, 200);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "receiver's Email:"))
